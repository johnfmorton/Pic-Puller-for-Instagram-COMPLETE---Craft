...
**Pic Puller for Instagram** helps you create your _own_ Instagram application that will live within your Craft CMS installation. Your Craft users can then allow access to their media streams via oAuth . 

Pic Puller provides Craft tags for you to access Instagram media in your templates. It also includes a field type that allows authorized users to browse their personal media stream on Instagram and/or search the entire set of images and videos on Instagram by tag.
...
* Version 1.6.0 (Nov 28, 2015)
	...
	- [Updated] Instagram has removed the User Feed from their API and it has now been removed from Pic Puller (This is the feed you see in the Instagram app on your phone, **not** the *media_recent* feed of images taken by a single user.)
...
### Migrating to non-square images

Instagram [announced](http://blog.instagram.com/post/127722429412/150827-portrait-and-landscape "Thinking Outside the Square: Support for Landscape and Portrait Formats on Instagram") on June 1, 2015, that they were no longer limiting media to only square formats within Instagram. Pic Puller version 1.5.0 was created to take advantage of this update.

If you have created an Instagram application before that announcement, your Instagram app may still be serving only-square images even though you've upgraded to the new version of Pic Puller. You will need to log into your developer account at Instagram and confirm that you are ready to receive non-square media. Look for the *Migrations* tab in your application

![Migrating to non-square images](screenshots-for-docs/migrate-to-nonsquare.png)

Until you click this option, your Instagram app will only serve square images. As of June 1, 2016, you will automatically be migrated to serving non-square images.
...
There are 5 different template functions available with Pic Puller.
